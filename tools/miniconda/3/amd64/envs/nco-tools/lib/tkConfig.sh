...
# installed.
TK_PREFIX='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tk8.6.10/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/include'
...
# compiled.
TK_SRC_DIR='/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tk8.6.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tk8.6.10/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tk8.6.10/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib/libtkstub8.6.a'
