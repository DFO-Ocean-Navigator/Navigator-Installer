...
TCL_CC='/home/conda/feedstock_root/build_artifacts/tk_1574438067470/_build_env/bin/x86_64-conda_cos6-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -Wl,-rpath-link,/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -L/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/home/conda/feedstock_root/build_artifacts/tk_1574438067470/_build_env/bin/x86_64-conda_cos6-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tcl8.6.10/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/include'
...
# compiled.
TCL_SRC_DIR='/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tcl8.6.10'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tcl8.6.10/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/conda/feedstock_root/build_artifacts/tk_1574438067470/work/tcl8.6.10/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/mnt/ramdisk/tools/miniconda/3/amd64/envs/nco-tools/lib/libtclstub8.6.a'
