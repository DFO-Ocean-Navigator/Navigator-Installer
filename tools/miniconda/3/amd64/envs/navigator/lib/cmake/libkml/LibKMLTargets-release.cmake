...
set_target_properties(kmlbase PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libexpat.so;/home/conda/feedstock_root/build_artifacts/libkml_1543237805195/_build_env/lib/libz.so;/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libminizip.so;/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/liburiparser.so;/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libexpat.so"
  IMPORTED_LOCATION_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlbase.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlbase.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlbase )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlbase "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlbase.so.1.3.0" )
...
set_target_properties(kmldom PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmldom.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmldom.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmldom )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmldom "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmldom.so.1.3.0" )
...
set_target_properties(kmlxsd PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "kmlbase"
  IMPORTED_LOCATION_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlxsd.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlxsd.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlxsd )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlxsd "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlxsd.so.1.3.0" )
...
set_target_properties(kmlengine PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlengine.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlengine.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlengine )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlengine "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlengine.so.1.3.0" )
...
set_target_properties(kmlconvenience PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlconvenience.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlconvenience.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlconvenience )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlconvenience "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlconvenience.so.1.3.0" )
...
set_target_properties(kmlregionator PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlregionator.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlregionator.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlregionator )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlregionator "/mnt/ramdisk/tools/miniconda/3/amd64/envs/navigator/lib/libkmlregionator.so.1.3.0" )
