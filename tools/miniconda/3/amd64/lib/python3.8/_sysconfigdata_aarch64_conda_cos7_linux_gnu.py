...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'aarch64-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/mnt/ramdisk/tools/miniconda/3/amd64/lib '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/mnt/ramdisk/tools/miniconda/3/amd64/lib '
                      '-L/mnt/ramdisk/tools/miniconda/3/amd64/lib',
 'CONFIG_ARGS': "'--prefix=/mnt/ramdisk/tools/miniconda/3/amd64' "
                ...
                "-I/mnt/ramdisk/tools/miniconda/3/amd64/include' "
                "'CPP=/mnt/ramdisk/tools/miniconda/3/amd64/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/mnt/ramdisk/tools/miniconda/3/amd64/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/mnt/ramdisk/tools/miniconda/3/amd64/lib/pkgconfig',
 'LIBPL':
     '/mnt/ramdisk/tools/miniconda/3/amd64/lib/python3.8/config-3.8-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/mnt/ramdisk/tools/miniconda/3/amd64/include',
 'OPENSSL_LDFLAGS': '-L/mnt/ramdisk/tools/miniconda/3/amd64/lib',
